...
<h3 id="elevated-button-tokens">
	Elevated button tokens<a href="#elevated-button-tokens" aria-hidden="true" tabindex="-1">#</a>
</h3>
<table>
	<thead>
		<tr>
