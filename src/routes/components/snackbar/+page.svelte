...
>
<Code
	value={`<Snackbar label="Single line snackbar with action and icon" actionLabel="Action">
	{#snippet icon()}
		<CloseIcon />
	{/snippet}
</Snackbar>`}
...
>
<Code
	value={`<Snackbar label="Two line snackbar" supportingText="with action and icon" actionLabel="Action">
	{#snippet icon()}
		<CloseIcon />
	{/snippet}
</Snackbar>`}
